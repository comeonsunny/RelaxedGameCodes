def find_next_empty(puzzle):
    ...
    # keep in mind that we're using 0-8 for our indices
    for r in range(9):
        for c in range(9):
            if puzzle[r][c] == -1:
                return r, c
...
def is_valid(puzzle, guess, row, col):
    ...
    # and then the square
    # this is tricky, but we want to get where the 3x3 square starts and iterate over the 3 values in the row/column
    row_start = (row // 3) * 3
    col_start = (col // 3) * 3
